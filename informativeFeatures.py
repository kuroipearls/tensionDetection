...
def print_top10(vect, clf, class_labels=clf.classes_):
    ...
    for i, class_label in enumerate(class_labels):
        ...
        plt.ylabel('Weight')
        if(i == 0):
            plt.title('Top 15 Features in Class 0')
            plt.savefig('class0v.png', bbox_inches='tight')
        elif(i == 1):
            plt.title('Top 15 Features in Class 1')
            plt.savefig('class1v.png', bbox_inches='tight')
        else: 
            plt.title('Top 15 Features in Class 2')
            plt.savefig('class2v.png', bbox_inches='tight')
        # print(clf.coef_)
